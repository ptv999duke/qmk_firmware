 ...
 * `--------+------+------+------+------+-------------'             `-------------+------+------+------+------+--------'
 *   |MO(L1)|  '"  |  Alt | Left | Right|                                   18898      |  Up  | Down |   [  |   ]  |   ~L2  |
 *   `----------------------------------'                                         `------------------------------------'
 *                                        ,----------------.        ,-----------------.
 *                                        | LGui |   App   |        | Alt     |  Esc  |
 *                                 ,------|------|---------|        |---------+-------|------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(1),    KC_QUOT,  KC_LALT,  KC_LEFT, KC_RGHT,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_F11, KC_F12,   KC_UP,    KC_BTN1,  KC_BTN2,
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [3] = ACTION_LAYER_TOGGLE(SYMB),
    [4] = ACTION_LAYER_TOGGLE(MDIA),
};
...
// void momentary_layer_one(qk_tap_dance_state_t *state, void *user_data) {
//   ACTION_LAYER_MOMENTARY(1);
// }

// void toggle_layer_one(qk_tap_dance_state_t *state, void *user_data) {
//   ACTION_LAYER_TOGGLE(1);
// }

// qk_tap_dance_action_t tap_dance_actions[] = {
//   [LAYER_ONE_TOGGLE]  = ACTION_TAP_DANCE_DOUBLE(momentary_layer_one, toggle_layer_one)
// };
